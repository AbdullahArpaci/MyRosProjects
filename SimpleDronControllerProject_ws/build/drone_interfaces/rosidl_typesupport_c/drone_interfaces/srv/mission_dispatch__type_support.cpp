...
static const _MissionDispatch_Request_type_support_symbol_names_t _MissionDispatch_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_interfaces, srv, MissionDispatch_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, drone_interfaces, srv, MissionDispatch_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, drone_interfaces, srv, MissionDispatch_Request)() {
  return &::drone_interfaces::srv::rosidl_typesupport_c::MissionDispatch_Request_message_type_support_handle;
}
...
static const _MissionDispatch_Response_type_support_symbol_names_t _MissionDispatch_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_interfaces, srv, MissionDispatch_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, drone_interfaces, srv, MissionDispatch_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, drone_interfaces, srv, MissionDispatch_Response)() {
  return &::drone_interfaces::srv::rosidl_typesupport_c::MissionDispatch_Response_message_type_support_handle;
}
...
static const _MissionDispatch_type_support_symbol_names_t _MissionDispatch_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_interfaces, srv, MissionDispatch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, drone_interfaces, srv, MissionDispatch)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, drone_interfaces, srv, MissionDispatch)() {
  return &::drone_interfaces::srv::rosidl_typesupport_c::MissionDispatch_service_type_support_handle;
}
