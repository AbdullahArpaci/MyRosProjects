...
{
  new (message_memory) robot_interfaces1::msg::ObstacleInfo(_init);
}

void ObstacleInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces1::msg::ObstacleInfo *>(message_memory);
  typed_message->~ObstacleInfo();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleInfo_message_member_array[2] = {
  {
    "found",  // name
    ...
    offsetof(robot_interfaces1::msg::ObstacleInfo, found),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces1::msg::ObstacleInfo, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObstacleInfo_message_members = {
  "robot_interfaces1::msg",  // message namespace
  "ObstacleInfo",  // message name
  2,  // number of fields
  sizeof(robot_interfaces1::msg::ObstacleInfo),
...
{
  return &::robot_interfaces1::msg::rosidl_typesupport_introspection_cpp::ObstacleInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces1, msg, ObstacleInfo)() {
  return &::robot_interfaces1::msg::rosidl_typesupport_introspection_cpp::ObstacleInfo_message_type_support_handle;
}
