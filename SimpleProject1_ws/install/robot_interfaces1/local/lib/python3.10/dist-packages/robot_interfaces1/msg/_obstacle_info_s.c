...
bool robot_interfaces1__msg__obstacle_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces1.msg._obstacle_info.ObstacleInfo", full_classname_dest, 49) == 0);
  }
  robot_interfaces1__msg__ObstacleInfo * ros_message = _ros_message;
  {  // found
...
PyObject * robot_interfaces1__msg__obstacle_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces1.msg._obstacle_info");
