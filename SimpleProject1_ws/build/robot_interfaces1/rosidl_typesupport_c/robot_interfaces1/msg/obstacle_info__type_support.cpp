...
static const _ObstacleInfo_type_support_symbol_names_t _ObstacleInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces1, msg, ObstacleInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_interfaces1, msg, ObstacleInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_interfaces1, msg, ObstacleInfo)() {
  return &::robot_interfaces1::msg::rosidl_typesupport_c::ObstacleInfo_message_type_support_handle;
}
