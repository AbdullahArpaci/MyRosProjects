...
#include "robot_interfaces1/msg/detail/obstacle_info__rosidl_typesupport_fastrtps_c.h"
...
#include "robot_interfaces1/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _ObstacleInfo__ros_msg_type = robot_interfaces1__msg__ObstacleInfo;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces1
size_t get_serialized_size_robot_interfaces1__msg__ObstacleInfo(
  const void * untyped_ros_message,
...
static uint32_t _ObstacleInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces1__msg__ObstacleInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces1
size_t max_serialized_size_robot_interfaces1__msg__ObstacleInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces1__msg__ObstacleInfo;
    is_plain =
      (
...
static size_t _ObstacleInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces1__msg__ObstacleInfo(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces1, msg, ObstacleInfo)() {
